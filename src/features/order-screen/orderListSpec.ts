...
export const ORDER_LIST_SPEC: ListScreenSpec = {
  ...
  resultColumns: [
    ...
    { field: 'quantity', headerName: '数量', width: 88, format: 'number', align: 'right' },
    { field: 'unitPrice', headerName: '単価', width: 100, format: 'number', align: 'right' },
    { field: 'amount', headerName: '明細金額', width: 120, format: 'number', align: 'right' },
